...
def get_atomic_invariants(atom, max_atomic_num: int = 100):
    atomic_invariants = []
...
def get_atomic_invariants_as_dict(atom):
    invariants = get_atomic_invariants(atom)
...
class GraphEncoder:
    def __init__(self, fix_seed: bool = True) -> "GraphEncoder":
